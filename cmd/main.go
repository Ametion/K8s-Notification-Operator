...
import (
	...
	notificationv1alpha1 "github.com/Ametion/k8s-notification-operator/api/v1alpha1"
	"github.com/Ametion/k8s-notification-operator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "116d55b1.res-x.com",
